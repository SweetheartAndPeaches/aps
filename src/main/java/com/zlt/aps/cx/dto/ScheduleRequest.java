...
public class ScheduleRequest implements Serializable {
    ...
    @Schema(description = "排程模式：NORMAL-正常排程，RE_SCHEDULE-重排程")
    private String scheduleMode;

    @Schema(description = "重排程类型：MACHINE_BREAKDOWN-机台故障，URGENT_ORDER-紧急订单，MATERIAL_SHORTAGE-物料短缺")
    private String reScheduleType;

    @Schema(description = "受影响的机台编码列表")
    private List<String> affectedMachineCodes;

    @Schema(description = "是否覆盖已有排程")
